...
public class tripadvisor_task4 {
  ...
  public static List<Point> parseHits(String hits, int maxHits) {
  ...
  public static List<Ship> parseShips(String ships, int maxShips) {
